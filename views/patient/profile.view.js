/**
 * Patient profile — view personal data and edit the allowed fields
 * (Part 4: phone, gender and emergency contact only).
 *
 * API:
 *   GET /api/patient/profile
 *   PUT /api/patient/profile
 *
 * Password changes reuse the existing authentication flow
 * (/forgot-password) — never a custom endpoint.
 */
      ...
      <div class="lg:col-span-3">
        ${Card({
          content: `
            ...
            <p class="mb-5 text-sm text-muted">Estos son los únicos campos que puedes editar. Los datos clínicos los gestiona tu profesional.</p>
